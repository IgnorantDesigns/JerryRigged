...
- The apply/cancel contract UMG usage guide follow-up documents safe future Blueprint subclassing/binding for that shell without adding widget assets, settings controls, startup wiring, or persistence lifecycle mutation.
