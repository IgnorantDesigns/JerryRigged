...
10. Add actual Apply execution helper APIs without widget controls.
11. Add a backend selector UI shell that edits pending state only.
12. Add SQLite path display/edit validation that does not create files.
13. Add reset UX confirmation and smoke coverage through SQLUICore database management helpers.
14. Add packaged validation for any startup, config, default map, viewport, or packaged lifecycle integration.
