...
- SQLUICore now also codifies a guarded production target enablement request: explicit enablement can be requested and reported, but it remains blocked, non-writable, pathless, deterministic, and side-effect free because no concrete production target is selected yet.
