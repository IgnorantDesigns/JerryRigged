...
Add executable migrations for the agreed schema and record them in `sqlui_schema_migrations`. Ensure migration failures produce clear unavailable-backend results.
