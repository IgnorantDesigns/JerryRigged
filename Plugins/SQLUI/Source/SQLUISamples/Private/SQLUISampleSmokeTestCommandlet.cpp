	...
	const FSQLUISampleSmokeTestResult& Result)
{
	...
	LogPersistenceSettingsDraftBool(TEXT("backend-only production apply unavailable without request"), ProbeResult.bBackendOnlyProductionApplyUnavailableWithoutRequest);
	LogPersistenceSettingsDraftBool(TEXT("backend-only production apply created target"), ProbeResult.bBackendOnlyProductionApplyCreatedTarget);
	LogPersistenceSettingsDraftBool(TEXT("backend-only production apply wrote backend only"), ProbeResult.bBackendOnlyProductionApplyWroteBackendOnly);
	LogPersistenceSettingsDraftBool(TEXT("backend-only production apply did not write SQLite path"), ProbeResult.bBackendOnlyProductionApplyDidNotWriteSQLitePath);
	LogPersistenceSettingsDraftBool(TEXT("backend-only production apply did not write provider auto-init"), ProbeResult.bBackendOnlyProductionApplyDidNotWriteProviderAutoInit);
	LogPersistenceSettingsDraftBool(TEXT("backend-only production apply SQLite did not create DB"), ProbeResult.bBackendOnlyProductionApplySQLiteDidNotCreateDb);
	LogPersistenceSettingsDraftBool(TEXT("backend-only production apply no lifecycle side effects"), ProbeResult.bBackendOnlyProductionApplyNoLifecycleSideEffects);
	LogPersistenceSettingsDraftBool(TEXT("backend-only production apply preserved config files"), ProbeResult.bBackendOnlyProductionApplyPreservedConfigFiles);
	LogPersistenceSettingsDraftBool(TEXT("backend-only production apply no-change no-op"), ProbeResult.bBackendOnlyProductionApplyNoChangeNoOp);
	LogPersistenceSettingsDraftBool(TEXT("backend-only production apply provider auto-init rejected"), ProbeResult.bBackendOnlyProductionApplyProviderAutoInitRejected);
	LogPersistenceSettingsDraftBool(TEXT("backend-only production apply invalid draft refused"), ProbeResult.bBackendOnlyProductionApplyInvalidDraftRefused);
