...
struct SQLUISAMPLES_API FSQLUISamplePersistenceSettingsDraftProbeResult
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bApplyConfigTargetPolicyDocumentedStrategyResolved = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bApplyConfigTargetPolicyDocumentedStrategyCannotWrite = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bApplyConfigTargetPolicyDocumentedStrategyNoWritablePath = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bApplyConfigTargetPolicySelectedProductionDescriptorResolved = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bApplyConfigTargetPolicySelectedProductionPathDescribed = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bApplyConfigTargetPolicySelectedProductionDescriptorCannotWrite = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bApplyConfigTargetPolicySelectedProductionDescriptorNotProjectConfig = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bApplyConfigTargetPolicySelectedProductionTargetNotCreated = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bApplyConfigTargetPolicyGuardedProductionDescriptorBlocked = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bApplyConfigTargetPolicyDocumentedStrategyDeterministic = false;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bApplyConfigTargetPolicyProductionEnablementWithoutRequestBlocked = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bApplyConfigTargetPolicyProductionEnablementRequestRecorded = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bApplyConfigTargetPolicyProductionEnablementBlocked = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bApplyConfigTargetPolicyProductionEnablementNoWritablePath = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bApplyConfigTargetPolicyProductionEnablementNoSideEffects = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bApplyConfigTargetPolicyProductionEnablementDeterministic = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionApplyUnavailableWithoutRequest = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionApplyCreatedTarget = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionApplyWroteBackendOnly = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionApplyDidNotWriteSQLitePath = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionApplyDidNotWriteProviderAutoInit = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionApplySQLiteDidNotCreateDb = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionApplyNoLifecycleSideEffects = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionApplyPreservedConfigFiles = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionApplyNoChangeNoOp = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionApplyProviderAutoInitRejected = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionApplyInvalidDraftRefused = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionApplyInvalidDidNotMutate = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionApplyArtifactCleaned = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionApplyDirectoryCleaned = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionReadAbsentNoOverride = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionReadAbsentDidNotCreateTarget = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionReadAfterWriteSucceeded = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionReadBackendMatched = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionReadNoRuntimeSideEffects = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionReadUnknownBackendRejected = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionReadMalformedRejected = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionReadArtifactCleaned = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SQLUI|Samples")
	bool bBackendOnlyProductionReadDirectoryCleaned = false;
