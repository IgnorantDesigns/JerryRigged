...
FString FSQLUISQLiteLayoutRepositoryWorker::ResolveDatabasePath(
	const FString& DatabasePath)
{
	if (DatabasePath.IsEmpty())
	{
	...
	return NormalizeSQLUISQLiteLayoutRepositoryPath(DatabasePath);
}

FSQLUILayoutSaveResult FSQLUISQLiteLayoutRepositoryWorker::MakeReadOnlySaveFailure(
	const FString& LayoutId)
{
	return MakeSQLUISQLiteLayoutReadOnlySaveFailure(LayoutId);
}

FSQLUILayoutRepositoryRemoveResult FSQLUISQLiteLayoutRepositoryWorker::MakeReadOnlyRemoveFailure(
	const FString& LayoutId)
{
	return MakeSQLUISQLiteLayoutReadOnlyRemoveFailure(LayoutId);
}

FSQLUILayoutRepositoryClearResult FSQLUISQLiteLayoutRepositoryWorker::MakeReadOnlyClearFailure()
{
	return MakeSQLUISQLiteLayoutReadOnlyClearFailure();
}

FSQLUILayoutLoadResult FSQLUISQLiteLayoutRepositoryWorker::LoadLayoutById(
	const FSQLUISQLiteLayoutRepositoryWorkerSettings& Settings,
	const FString& LayoutId)
{
	if (LayoutId.IsEmpty())
...
FSQLUILayoutRepositoryListResult FSQLUISQLiteLayoutRepositoryWorker::ListLayouts(
	const FSQLUISQLiteLayoutRepositoryWorkerSettings& Settings)
{
	FSQLUILayoutRepositoryListResult Result;
...
FSQLUILayoutSaveResult FSQLUISQLiteLayoutRepositoryWorker::SaveLayout(
	const FSQLUISQLiteLayoutRepositoryWorkerSettings& Settings,
	const FSQLUILayoutDocument& Document)
{
...
FSQLUILayoutRepositoryRemoveResult FSQLUISQLiteLayoutRepositoryWorker::RemoveLayout(
	const FSQLUISQLiteLayoutRepositoryWorkerSettings& Settings,
	const FString& LayoutId)
{
	if (LayoutId.IsEmpty())
...
FSQLUILayoutRepositoryClearResult FSQLUISQLiteLayoutRepositoryWorker::ClearLayouts(
	const FSQLUISQLiteLayoutRepositoryWorkerSettings& Settings)
{
	const FString DatabasePath = ResolveDatabasePath(Settings.DatabasePath);
	FString ErrorMessage;
